...
from sqlalchemy import Column, String, Integer, Numeric, Date, DateTime, ForeignKey, JSON, Enum as SAEnum
...
class Deal(Base):
    ...
    anomaly_flags     = Column(JSON, nullable=True, default=list)  # e.g. ["high_rent", "long_term"]
