...
def market_summary(
    ...
    if not deals:
        raise HTTPException(status_code=404, detail="No deals found for this market")
    ...
    mid = count // 2
    median = round(
        rents[mid] if count % 2 != 0 else (rents[mid - 1] + rents[mid]) / 2,
        2,
    )
    ...
    return MarketSummaryResponse(
        ...
        lease_type_breakdown=breakdown,
    )